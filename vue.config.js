...
module.exports = {
  ...
  css: {
    ...
    loaderOptions: {
      sass: {
        data: `@import "@/common/scss/_util.scss";`
      }
    },
  },
  ...
  devServer: {
    ...
    proxy: { // 设置代理
      '/api': {
        // target: 'http://api1.koudejun.com',
        target: 'http://test.koudejun.com',
        // target: 'http://192.168.2.123:10010',
        changeOrigin: true
      },
      // '/api/1/v1/item/m': {
      ...
      // },
      // '/api/1/v1/content/m': {
      //     target: 'http://192.168.2.188:10088/',
      //     pathRewrite: {'^/api/1/v1': ''},
      //     changeOrigin: true
      // },
      //
